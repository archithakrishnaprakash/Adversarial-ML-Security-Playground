...
const NAV = [
  ...
  { href: "/poisoning-lab", label: "Poisoning Lab", glyph: "☣" },
  { href: "/defense-lab", label: "Defense Lab", glyph: "◆" },
  { href: "/robustness-report", label: "Robustness Report", glyph: "▤" },
  { href: "/security-assessment", label: "Security Assessment", glyph: "🛈" },
  { href: "/leaderboard", label: "Leaderboard", glyph: "▲" },
  { href: "/experiments", label: "Benchmark & Experiments", glyph: "▦" },
];
    ...
    <aside className="w-60 shrink-0 border-r border-border bg-panel min-h-screen flex flex-col">
      <div className="px-5 py-6 border-b border-border">
        ...
        <p className="text-[10px] text-muted mt-1 leading-snug">
          Adversarial ML Security Assessment Framework
        </p>
      </div>
