        ...
        rows.append(
            {
                ...
                "dataset": exp["dataset"],
                # both kept: robustness_score for backward compatibility,
                # aegis_robustness_index as the explicitly-labeled name —
                # identical value (see evaluate_robustness's disclaimer note).
                "robustness_score": result.get("robustness_score"),
                "aegis_robustness_index": result.get("aegis_robustness_index", result.get("robustness_score")),
                "clean_accuracy": result.get("clean_accuracy"),
                "mean_robust_accuracy": result.get("mean_robust_accuracy"),
