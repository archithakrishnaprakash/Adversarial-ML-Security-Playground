...
def generate_security_assessment(
    ...
    return {
        ...
        # aegis_robustness_index as the preferred, explicitly-labeled name —
        # same value either way (see evaluate_robustness's disclaimer note).
        "robustness_score": score,
        "aegis_robustness_index": score,
        "clean_accuracy": clean_acc,
        "mean_robust_accuracy": benchmark.get("mean_robust_accuracy"),
